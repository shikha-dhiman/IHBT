...
class receptionistFamilyController extends Controller
{
  public function index(Request $req)
    {
        ...
        return view('Receptionist.Members.index', compact('family_member'));
    }
    ...
    public function add(Request $req)
    {
    	if($req->isMethod('post')){
            ...
            return redirect('receptionist_user/employee/family/?id='.$req->user_id.'&type='.$req->input('type'))->with('success', 'Added successfully.');
    	}
    	$employee_id = User::where('user_type', $req->input('type'))->get();
    	return view('Receptionist.Members.add', compact('employee_id'));
    }
    public function edit(Request $req)
    {
        ...
        if($req->isMethod('post')){
            ...
            return redirect('receptionist_user/employee/family/?id='.$req->input('id').'&type='.$req->type)->with('success', 'Updated successfully.');
        }
        $family_member = family_member::where('id', $req->member_id)->get();
        return view('Receptionist.Members.edit', compact('family_member'));
    }
