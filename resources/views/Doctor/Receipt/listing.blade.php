            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="{{url('doctor/receipts')}}" class="capt-cls">Employees</a></li>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{url('doctor/receipts/receipts?emp_id='.$emp->id.'&family_id=')}}" class="btn mb-1 btn-light btn-rounded btn-icon btn-common-pdng btn-listing btn-custom-padding" title="List receipt"><i class="icon-doc"></i></a>
                                            </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{url('doctor/receipts/receipts?emp_id='.$emp->id.'&family_id='.$val->id)}}" class="btn mb-1 btn-light btn-rounded btn-icon btn-common-pdng btn-listing btn-custom-padding" title="List receipt"><i class="icon-doc"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
