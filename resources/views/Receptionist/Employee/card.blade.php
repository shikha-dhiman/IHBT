                    ...
                    <div class="col-lg-12">
                        <div class="card">
                          ...
                          <div class="col-sm-4 div-pdf">
                              <a href="{{url('receptionist_user/employee/card-pdf?id='.$val->id)}}"><img src="
                              {{asset('public/user_asset/images/pdf-file.png')}}" alt="" style="height: 40px;"></a>
                          </div>
                            <div class="card-body">
                                <div class="col-lg-12">
                                    <div class="card">
...
{{asset('public/user_asset/images/csirlogo-setting.png')}}" alt="" style="height: 57px;"></div>
...
{{asset('public/user_asset/images/csirlogo.png')}}" alt="" style="height: 57px;"></div>
                                            </div>
                                            ...
                                            <div class="col-lg-12" style="display: flex;">
                                               <div class="col-sm-3 sanjay-div">
                                                <img src="
{{asset('public/user_asset/images/'.$val->image)}}" alt="">
                                               </div>
                                               ...
                                               <div class="col-sm-3 sanjay-qr">
                                                <img src="
{{asset('public/user_asset/images/qrcode.png')}}" alt="">
                                               </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                          ...
                                          <div class="col-lg-12" style="text-align: center;">
                                            <img src="
{{asset('public/user_asset/images/csirlogo.png')}}" alt="" style="height: 104px;">
                                          </div>
