            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{url('receptionist_user/employee?type=1')}}" class="capt-cls">Employee</a></li>
                        <li class="breadcrumb-item active"><a href="{{url('receptionist_user/employee/family?id='.request()->input('id').'&type='.request()->input('type'))}}" class="capt-cls">Family</a></li>
