            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{url('owner/receptionist?type=2')}}" class="capt-cls">Receptionist</a></li>
                        @endif
                        @if(request()->input('type') == 3)
                        <li class="breadcrumb-item active"><a href="{{url('owner/doctor?type=3')}}" class="capt-cls">Doctor</a></li>
                        @endif
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="input_type" value="{{request()->input('type')}}">
                                    <div class="serving">
                                    </div>
                                    <div class="retired">
                                    </div>
        ...
        html+='<div class="form-group row">';
            html+='<div class="col-lg-12">';
                html+='<div class="form-row">';
                    ...
                    html+='</div>';
                    var id = $('input[name="input_type"]').val();
                    if(id == '1'){
    ...
    retired+='</div>';
     retired+='<div class="form-group row">';
        retired+='<div class="col-lg-12">';
            retired+='<div class="form-row">';
                retired+='<div class="col-6">';
                    retired+='<label class="">प्रोफ़ाइल छवि/Profile image</label>';
