...
<body>
  <table>
    ...
    <tr>
      <td rowspan="3" style="text-align: right;"><img src="{{asset('public/user_asset/images/csirlogo-setting.png')}}" height="50" width="50"></td>
      <td colspan="2" style="text-align: center;"><!-- सी.एस.आई.आर- हिमालय जैवसंपदा प्रौद्योगिकी संस्थान --></td>      
      <td rowspan="3"><img src="{{asset('public/user_asset/images/csirlogo.png')}}" height="50" width="50"></td>
    </tr>
    <tr>
      <td colspan="2" style="text-align: center;">CSIR - Institute of Himalayan Bioresource Technology
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td></td>
      <td class="red" colspan="2" style="text-align: center;text-decoration: underline; vertical-align: top;"><h3><!-- स्वास्थ्य कार्ड --> Health Card</h3></td>
      <td></td>
    </tr>     
    <tr>
  ...
  <table>
    <tr>
      <td></td>
        <td colspan="2" style="text-align: right;"><!-- परिवार के सदस्यों की संख्या  --> No. of Family members:</td>
        <td colspan="3">&nbsp;{{$family_member}}</td>
    </tr>
    <tr>
      <td></td>
      <td colspan="2" style="text-align: right;"><!-- संपर्क नंबर --> Contact No.:</td>
      <td colspan="3">&nbsp;{{$val->mobile}}</td>
    </tr>
    <tr>
      <td></td>
      <td colspan="2" style="text-align: right;"><!-- कर्मचारी का पता -->  Employee Address:</td>
      <td colspan="3"><span style="text-transform: capitalize;">&nbsp;{{$val->employee_address}}</span></td>
    </tr>
    @endforeach   
    <tr>
      <td></td>     
    ...
    <tr>      
      <td colspan="6" style="text-align: center;">In case of loss of this card, the fact should be reported immediately to the police and issuing Authority</td>   
    </tr>
    <tr>
