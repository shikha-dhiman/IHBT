                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="header-body">
                                    ...
                                    <a href="{{url('owner/employee/'.request()->route()->getName().'/add?id='.request()->input('id').'&type='.request()->input('type'))}}" class="btn btn-rounded btn-icon btn-add-event" id=""><i class="ti-plus"></i></a>
                                    <div class="employee_dropdown">
                                        <input type="hidden" name="select-url" value="{{url('owner/members/select-members')}}" id="selecturl">
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                          @foreach($family_member as $key => $val)
                                            <tr>
                                                ...
                                                <td><a href="{{url('owner/employee/family/edit?id='.$val->user_id.'&type='.request()->input('type').'&member_id='.$val->id)}}" class="btn btn-success btn-rounded btn-icon btn-common-pdng" title="Edit"><i class="ti-pencil"></i></a>
 ...
 <script type="text/javascript">
  $(document).ready(function(){
   jQuery(".delete-value").click(function(e){
        e.preventDefault();
        var url = "{{url('owner/employee/family/delete')}}";
